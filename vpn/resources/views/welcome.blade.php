      ...
      <div class="center-container">
        ...
        <div class="about__list">
          ...
          <div class="about__list-card">
            ...
            <div class="about__card-text">Создать Proxy сервер -сервис, который будет отличаться поддержкой всех современных протоколов и возможностью подключения в один клик. Мы нацелены на обеспечение безопасности и конфиденциальности данных наших пользователей.</div>
          </div>
          <div class="about__list-card">
        ...
        <div class="faq__questions-list">
          <div class="faq__questions-list-col">
            ...
            <div class="faq__questions-list-item faq__questions-list-item--opened" itemscope="" itemtype="https://schema.org/Question">
              ...
              <div class="faq__questions-list-item-text" itemscope="" itemtype="https://schema.org/Answer">
                <div itemprop="text">
                  Использование надежного и проверенного VPN-сервиса значительно снижает риски утечки финансовых данных при работе с банковскими приложениями. Однако полностью исключить риск невозможно, особенно при использовании менее известных VPN сервер-провайдеров.
                </div>
              </div>
            </div>
